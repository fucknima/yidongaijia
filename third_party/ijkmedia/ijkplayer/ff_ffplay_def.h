...
typedef struct FFPlayer {
    ...
    /* recording: tee input packets to a file without interrupting playback */
    SDL_mutex       *record_mutex;
    AVFormatContext *record_ctx;
    int             *record_stream_map; /* input stream index -> record stream index, -1 if unmapped */
    int64_t          record_last_dts;
