...
private enum ReleaseNotesCatalog {
    static let all: [ReleaseNote] = [
        ReleaseNote(
            ...
            title: "短信验证码会话流程",
            details: [
                "按官方普通登录流程调用 authentication/sendMsg，并补齐手机号、设备品牌和机型字段。",
                "按官方实现使用 AES-128-ECB/PKCS7 加密短信登录手机号。",
                "补齐 IDMP AppID、sourceId、设备标识、地区参数和 UNIAUTH_PASSWORD 登录字段。",
                "发送验证码后复用同一网络会话和 Cookie 登录，避免 session 校验失败。",
